...
var boxs = [
    {
        selector: '#cover3',
        headline: 'Austin Motel',
        copy: '<a target="_blank" href="http://www.austinmotel.com/">Austin Motel</a> is one of the most recognisable buildings in the trendy South Congress area, if not for its bright lights then for its slightly phallic shaped sign - locals have affectionately dubbed it the "penis motel". For $150 a night and at the recommendation of <a target="_blank" href="https://twitter.com/TWalk/status/347006443104382976">@TWalk</a>, we checked into a huge, clean room – nothing outwardly fancy about the decor, but it was clean, bright and funky.',
        address: "• <a target='_blank' href='www.austinmotel.com'>Austin Motel</a>, 1220 S Congress Ave, Austin, Texas",
...

    {
        ...
        copy: "Since 99% of tips for the Austin area involve food, and 99% of those food tips involve BBQ, it's important to note that we didn't take our First Taste of Texas BBQ decision lightly. At Smitty's, we ordered a pound each of of the most popular meets (ribs, brisket and sausage), which came on tear sheets of thick brown paper . Dizzy with meat coma.",
        content: '<img src="images/smittys.jpg">',
        address: "• <a target='_blank' href='www.smittysmarket.com'>Smitty's Market</a>, 208 S Commerce St  Lockhart, Texas"
    },

    {
        selector: '#cover6',
        headline: 'El Cosmico',
        copy: "We arrived in Marfa after 10pm, about four hours later than planned and two hours later than the office at our hotel, <a target='_blank' href='http://elcosmico.com/'>El Cosmico</a>, stays open. What followed was a night of toss-and-turn sleep in a trailer that seemed to retain all of the previous day's heat, until the temperature suddenly dropped to freezing in the early morning.",
        content: '<img src="images/cosmico.jpg">',
        address: "• <a target='_blank' href='elcosmico.com'>El Cosmico</a>, 802 S Highland Ave  Marfa, Texas"
    },
...

    {
        ...
        copy: "We've officially entered the Road Trip segment of this live blog. It snuck up on us directly after we left Ingram. No cell service and very little scenery; the rolling green of Texas Hill Country shifted to the rocky expanse of West Texas before our eyes.",
...

    {
        ...
        copy: "We passed the New Mexico state line sign a bit ago and we're pleased to see that the residents here seem very excited to show us their state. We've logged over 1,000 miles in our rental car since picking it up in Austin on Sunday. To keep ourselves occupied, we've discussed the following: iceberg wedge salads (why?), diaper-wearing astronauts, Big Red-flavoured Icees, the secrets to long-lasting relationships (not road trips) and the ever-changing landscape outside.",
...

    {
        ...
        copy: "Baking in the 100-degree sun, the grey gravelled military cemetery looks like a really lonely place to spend eternity. In the middle is Billy the Kid's headstone. On one hand, the Kid is known as a thief and murderer, but his gregarious personality, hardscrabble upbringing and baby face has secured him a place in folk hero lore as well.",
...

    {
        selector: '#cover16',
        headline: 'Roswell',
        copy: "As you might've guessed, the town is decked in an alien theme - even the street lights look like little green men. We asked our hotel concierge about what it's like to live in a town known for aliens. 'It's better to be known for something than for nothing,' he said with a shrug. Can't argue with that.",
...

    {
        ...
        copy: "Lea Lake has a large recreation area, paddle posts and foam surfboards. Sadly, we don't have time do any of the three, but taking in the gorgeous view - again, brown rock against bright blue water and sky - was reason enough reason to visit. (And we dipped our toes.)",
...

    {
        ...
        copy: "Our last stop was the much-recommended Tinkertown Museum, built over four decades by circus and carnival painter Ross J Ward.The museum  is full of painted wooden carvings Ross hand-made over the years, and the walls are covered in glass mosaic. You can play with ancient carnival machines - discards Ross fixed up - and drop quarters into giant old accordion machines to play old time music. ",
